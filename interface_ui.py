...
"}")
        ...
        self.gridLayout_6.addWidget(self.radioButton_edary, 1, 0, 1, 1)
        self.radioButton_sayer = QtWidgets.QRadioButton(self.groupBox_Tozihat)
        self.radioButton_sayer.setChecked(True)
        ...
        self.gridLayout_6.addWidget(self.radioButton_tafkik, 0, 1, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.radioButton_nameEdarat, 0, 3, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.radioButton_Baresi, 0, 4, 1, 1)
        ...
        self.checkBox = QtWidgets.QCheckBox(self.groupBox_inputData)
        self.checkBox.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.checkBox.setObjectName("checkBox")
        self.horizontalLayout_Sang.addWidget(self.checkBox)
        ...
        self.radioButton_bakhsh26 = QtWidgets.QRadioButton(self.groupBox_inputData)
        self.radioButton_bakhsh26.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.radioButton_bakhsh26.setChecked(True)
        self.radioButton_bakhsh26.setObjectName("radioButton_bakhsh26")
        self.buttonGroup_2 = QtWidgets.QButtonGroup(MainWindow)
        self.buttonGroup_2.setObjectName("buttonGroup_2")
        self.buttonGroup_2.addButton(self.radioButton_bakhsh26)
        self.horizontalLayout_QRadio.addWidget(self.radioButton_bakhsh26)
        self.radioButton_bakhsh25 = QtWidgets.QRadioButton(self.groupBox_inputData)
        self.radioButton_bakhsh25.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.radioButton_bakhsh25.setChecked(False)
        self.radioButton_bakhsh25.setObjectName("radioButton_bakhsh25")
        self.buttonGroup_2.addButton(self.radioButton_bakhsh25)
        self.horizontalLayout_QRadio.addWidget(self.radioButton_bakhsh25)
...
"}")
        ...
        self.horizontalLayout_Sang_2.addItem(spacerItem14)
        ...
        self.horizontalLayout_Sang_2.addWidget(self.checkBox_2)
        spacerItem15 = QtWidgets.QSpacerItem(38, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_Sang_2.addItem(spacerItem15)
        ...
        self.horizontalLayout_QRadio_2.addWidget(self.radioButton_26)
        ...
        self.horizontalLayout_QRadio_2.addWidget(self.radioButton_25)
...
"}")
        ...
        self.gridLayout_5.addLayout(self.horizontalLayout_btnNew_2, 5, 0, 1, 1)
        self.tableView_result = QtWidgets.QTableView(self.groupBox)
        self.tableView_result.setObjectName("tableView_result")
        self.gridLayout_5.addWidget(self.tableView_result, 4, 0, 1, 1)
        self.label_showSearchResult = QtWidgets.QLabel(self.groupBox)
        self.label_showSearchResult.setText("")
        self.label_showSearchResult.setAlignment(QtCore.Qt.AlignCenter)
        self.label_showSearchResult.setObjectName("label_showSearchResult")
        self.gridLayout_5.addWidget(self.label_showSearchResult, 3, 0, 1, 1)
        ...
        MainWindow.setTabOrder(self.radioButton_bakhsh25, self.comboBox_Hamkaran)
        ...
        MainWindow.setTabOrder(self.radioButton_hamkar, self.radioButton_estelam)
        ...
        MainWindow.setTabOrder(self.radioButton_tajmii, self.textEdit_Tozihat)
        ...
        MainWindow.setTabOrder(self.lineEdit_sangFari_2, self.radioButton_26)
        MainWindow.setTabOrder(self.radioButton_26, self.radioButton_25)
        MainWindow.setTabOrder(self.radioButton_25, self.pushButton_search)
        MainWindow.setTabOrder(self.pushButton_search, self.tableView_result)
        MainWindow.setTabOrder(self.tableView_result, self.pushButton_bazgashBygani)
        MainWindow.setTabOrder(self.pushButton_bazgashBygani, self.tabWidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.textEdit_Tozihat.setStatusTip(_translate("MainWindow", "توضیحات"))
        ...
        self.checkBox.setStatusTip(_translate("MainWindow", "   دفتر خواسته شده از بایگانی   "))
        self.checkBox.setText(_translate("MainWindow", "دفتر"))
        self.label_2.setStatusTip(_translate("MainWindow", "بخش را انتخاب کنید"))
        self.label_2.setText(_translate("MainWindow", "بخش:"))
        self.radioButton_bakhsh26.setText(_translate("MainWindow", "26"))
        self.radioButton_bakhsh25.setText(_translate("MainWindow", "25"))
        ...
        self.pushButton_new.setStatusTip(_translate("MainWindow", "ریست کردن فرم"))
        ...
        self.pushButton_search.setStatusTip(_translate("MainWindow", " جستجو اطلاعات ذخیره شده کلیک کنید"))
        ...
        self.checkBox_2.setStatusTip(_translate("MainWindow", "   بازیابی دفتر خارج شده از بایگانی   "))
        self.checkBox_2.setText(_translate("MainWindow", "دفتر"))
        ...
        self.pushButton_bazgashBygani.setText(_translate("MainWindow", "                بازگشت به بایگانی                "))
