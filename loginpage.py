...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "صفحه ورود"))
        self.userline.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-size:6pt; color:#e7ffcb;\">نام کاربری خود را وارد کنید</span></p></body></html>"))
        self.userline.setPlaceholderText(_translate("Form", "نام کاربری"))
        self.passline.setToolTip(_translate("Form", "<html><head/><body><p><span style=\"font-size:6pt; color:#e7ffcb;\">رمز ورود خود را وارد کنید</span></p></body></html>"))
        self.passline.setPlaceholderText(_translate("Form", "رمز عبور"))
        self.btn_login.setText(_translate("Form", "ورود"))
