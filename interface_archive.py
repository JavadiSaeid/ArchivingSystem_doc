...
"")
        ...
        self.horizontalLayout_QRadio_2.addItem(spacerItem12)
        ...
        self.horizontalLayout_QRadio_2.addItem(spacerItem13)
...
"}")
        ...
        self.gridLayout_5.addWidget(self.tableView_result, 3, 0, 1, 1)
        ...
        self.pushButton_bazgashBygani.setEnabled(True)
...
"}")
        ...
        self.gridLayout_5.addLayout(self.horizontalLayout_btnNew_2, 4, 0, 1, 1)
        ...
        MainWindow.setTabOrder(self.radioButton_nameEdarat, self.radioButton_Baresi)
        MainWindow.setTabOrder(self.radioButton_Baresi, self.radioButton_darKhastSanad)
        MainWindow.setTabOrder(self.radioButton_darKhastSanad, self.radioButton_edary)
        MainWindow.setTabOrder(self.radioButton_edary, self.radioButton_Jari)
        MainWindow.setTabOrder(self.radioButton_Jari, self.radioButton_sayer)
        ...
        MainWindow.setTabOrder(self.pushButton_new, self.checkBox_daftar)
        MainWindow.setTabOrder(self.checkBox_daftar, self.lineEdit_sangAsli_2)
        MainWindow.setTabOrder(self.lineEdit_sangAsli_2, self.lineEdit_sangFari_2)
        MainWindow.setTabOrder(self.lineEdit_sangFari_2, self.radioButton_bakhsh26_2)
        MainWindow.setTabOrder(self.radioButton_bakhsh26_2, self.radioButton_bakhsh25_2)
        MainWindow.setTabOrder(self.radioButton_bakhsh25_2, self.pushButton_search)
        MainWindow.setTabOrder(self.pushButton_search, self.checkBox_daftar_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton_bakhsh26.setStatusTip(_translate("MainWindow", "بخش 26 گیلان"))
        self.radioButton_bakhsh26.setText(_translate("MainWindow", "26"))
        self.radioButton_bakhsh25.setStatusTip(_translate("MainWindow", "بخش 25 گیلان"))
