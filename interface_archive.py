...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_Hamkaran.setItemText(1, _translate("MainWindow", "اسماعیل دولتی"))
        self.comboBox_Hamkaran.setItemText(2, _translate("MainWindow", "صائمه امجدی"))
        self.comboBox_Hamkaran.setItemText(3, _translate("MainWindow", "سیدمحمد آتشی"))
        self.comboBox_Hamkaran.setItemText(4, _translate("MainWindow", "علی رحمانی"))
        self.comboBox_Hamkaran.setItemText(5, _translate("MainWindow", "آرمان کاظمی"))
        self.comboBox_Hamkaran.setItemText(6, _translate("MainWindow", "یداله شهبازی"))
        self.comboBox_Hamkaran.setItemText(7, _translate("MainWindow", "سیدرشید کاظمی"))
        self.comboBox_Hamkaran.setItemText(8, _translate("MainWindow", "سیدمحمد موسوی"))
        self.comboBox_Hamkaran.setItemText(9, _translate("MainWindow", "صدیقه روشن"))
        self.comboBox_Hamkaran.setItemText(10, _translate("MainWindow", "محسن مهرافشان"))
        self.comboBox_Hamkaran.setItemText(11, _translate("MainWindow", "علیرضا آزادی"))
        self.comboBox_Hamkaran.setItemText(12, _translate("MainWindow", "سایر"))
