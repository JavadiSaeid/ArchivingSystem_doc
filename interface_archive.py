...
"}")
        ...
        self.gridLayout_6.addWidget(self.radioButton_nameEdarat, 1, 3, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.radioButton_darKhastSanad, 0, 4, 1, 1)
        ...
        self.radioButton_roneveshNaqshe.setStyleSheet("QRadioButton{\n"
"background-color: rgba(0, 0, 0, 0);\n"
"font: 80 11pt \"A Arghavan\";\n"
"}")
        self.radioButton_roneveshNaqshe.setObjectName("radioButton_roneveshNaqshe")
        self.gridLayout_6.addWidget(self.radioButton_roneveshNaqshe, 0, 5, 1, 1)
...
"")
        ...
        self.gridLayout_7.addItem(spacerItem22, 1, 8, 1, 1)
        ...
        MainWindow.setTabOrder(self.radioButton_tafkik, self.radioButton_darKhastSanad)
        MainWindow.setTabOrder(self.radioButton_darKhastSanad, self.radioButton_roneveshNaqshe)
        MainWindow.setTabOrder(self.radioButton_roneveshNaqshe, self.radioButton_Baresi)
        ...
        MainWindow.setTabOrder(self.radioButton_Jari, self.radioButton_nameEdarat)
        MainWindow.setTabOrder(self.radioButton_nameEdarat, self.radioButton_sayer)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton_roneveshNaqshe.setText(_translate("MainWindow", "رونوشت نقشه/\n"
" صورتمجلس تفکیکی "))
